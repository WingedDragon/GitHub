...
class RepositoriesFragment : BaseFragment() {
    ...
    private val adapter = RepositoriesFragmentRecyclerViewAdapter(R.layout.repositories_fragment_recyclerview_item)
    private var page = 1
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View {
        root_view = inflater?.inflate(R.layout.fragment_repositories,container,false)!!
        isViewCreate = true
        InitView()
    ...
    override fun InitView() {
        InitSwipeRefreshLayout(root_view.repositories_fragment_SwipeRefreshLayout)
        InitRecyclerView(root_view.repositories_fragment_RecyclerView)
//        InitData()
    }
    ...
    private fun InitData() {
        ...
        if(AccountManage.hasLogin){
            ...
            NetManage.getAPIService()
                    .getUserRepositoriesResult(AccountManage.Login,"",page,15,"")
                    .observeOn(AndroidSchedulers.mainThread())
                    .subscribeOn(Schedulers.io())
                    .subscribe(object :Observer<MutableList<UserRepositories>>{
                        override fun onSubscribe(d: Disposable) {
                        }

                        override fun onNext(t: MutableList<UserRepositories>) {
    ...
    private fun InitRecyclerView(t: RecyclerView) {
        ...
        adapter.setOnItemClickListener { adapter, view, position ->
            val data = adapter.data[position] as UserRepositories
